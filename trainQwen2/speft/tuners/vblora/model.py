...
from speft.utils import TRANSFORMERS_MODELS_TO_VBLORA_TARGET_MODULES_MAPPING, ModulesToSaveWrapper, _get_submodules
...
class VBLoRAModel(BaseTuner):
    ...
    Example:
        ...
        >>> from speft import VBLoRAConfig, get_peft_model
